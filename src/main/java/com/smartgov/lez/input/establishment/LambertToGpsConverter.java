...
public class LambertToGpsConverter {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, JsonParseException, IOException {
		...
		CopertParser parser = new CopertParser(new File(LambertToGpsConverter.class.getResource("../copert/Hot_Emissions_Parameters_France.csv").getFile()), new Random(240720191835l));
